...
set scrolloff=8			" Sets number of lines from edge of screen to start scrolling
set termguicolors		" Sets the terminal GUI colours
set omnifunc=syntaxcomplete#Complete	" Enables syntax autocomplete
